// Taken from https://github.com/google/magika/tree/main/assets
const contentTypeMapping = {
	...
	django: {
		mime_type: 'text/x-django',
		group: 'code',
		description: 'Django source',
		extensions: [],
		is_text: false,
	},
	dll: {
	...
	dmscript: {
		mime_type: 'text/plain',
		group: 'code',
		description: 'Digital Micrograph Script',
		extensions: ['s'],
		is_text: true,
	},
	doc: {
	...
	ko: {
		mime_type: 'application/x-executable-elf',
		group: 'executable',
		description: 'ELF executable, kernel object',
		extensions: ['ko'],
		is_text: false,
	},
	kotlin: {
	...
	randomascii: {
		mime_type: 'text/plain',
		group: 'text',
		description: 'Random ASCII characters',
		extensions: [],
		is_text: true,
	},
	randombytes: {
	...
	txtascii: {
		mime_type: 'text/plain',
		group: 'text',
		description: 'Generic text document encoded in ASCII',
		extensions: ['txt'],
		is_text: true,
	},
	txtutf16: {
		mime_type: 'text/plain',
		group: 'text',
		description: 'Generic text document encoded in UTF-16',
		extensions: ['txt'],
		is_text: true,
	},
	txtutf8: {
		mime_type: 'text/plain',
		group: 'text',
		description: 'Generic text document encoded in UTF-8',
		extensions: ['txt'],
		is_text: true,
	},
	typescript: {
	...
	udf: {
		...
		group: null,
		description: 'Universal Disc Format',
		extensions: [],
		is_text: false,
	},
	undefined: {
	...
	webtemplate: {
		mime_type: 'text/plain',
		group: 'code',
		description: 'Web templating language',
		extensions: [],
		is_text: true,
	},
	wim: {
...
export type ContentType = typeof contentTypeMapping
